   ...
   httpCaht = requests.get('https://github.com/DK-ARAFAT/Broken/blob/main/Approval.txt').text
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Assalamu%20Alaikum🌺%20!%20Please%20Approve%20My%20Key%20ᴀᴋᴀsʜ%20KiNg%20ToOLs%20:%20'+id);os.system('am start https://wa.me/+8801909170908?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
